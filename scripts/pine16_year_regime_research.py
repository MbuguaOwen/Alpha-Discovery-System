...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Run Pine16 year/regime research export.")
...
def main() -> None:
    ...
    print(f"by_year: {outs.research_by_year}")
    print(f"by_year_session: {outs.research_by_year_session}")
    print(f"robustness: {outs.research_robustness}")
