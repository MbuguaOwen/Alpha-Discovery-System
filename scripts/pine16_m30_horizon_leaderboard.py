...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Run Pine16 M30 horizon leaderboard export.")
...
def main() -> None:
    ...
    print(f"horizon_leaderboard_csv: {outs.horizon_leaderboard_csv}")
    print(f"best_horizons_csv: {outs.best_horizons_csv}")
