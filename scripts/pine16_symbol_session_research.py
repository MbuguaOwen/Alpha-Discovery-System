...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Run Pine16 symbol/session research export.")
...
def main() -> None:
    ...
    print(f"by_symbol: {outs.research_by_symbol}")
    print(f"by_session: {outs.research_by_session}")
    print(f"by_symbol_session: {outs.research_by_symbol_session}")
